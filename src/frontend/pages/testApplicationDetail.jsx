...
//       className="ml-auto pl-6 text-xs font-medium hover:underline opacity-70 hover:opacity-100 flex items-center"
//     >
//       Dismiss
//     </button>
//   </div>
...
export default function ApplicationDetail() {
  ...
  // Generate AI alternatives only when resubmit dialog opens
  // useEffect(() => {
  ...
  //       // 🟡 DEBUG: log payload instead of calling API
  //       console.log("📦 Alternative Documents AI Payload:", alternativeDocumentsAIPayload);
  ...
  //       // ✅ TEMP: mark as loaded so it doesn’t keep logging repeatedly
  //       setHasLoadedAlternativeDocs(true);

  //     } catch (err) {
  //       console.error("Error generating alternative document options:", err);
  ...
  //   if (docsLoading || qnaLoading) return;
    ...
    <div className="min-h-screen bg-background pb-24">
      <main className="container mx-auto animate-fade-in px-6 py-8">
        ...
        <ResubmitDialog
          ...
          requiredQuestions={requiredQns}
          onSuccess={handleResubmitSuccess}
          alternativeDocsLoading={alternativeDocsLoading}
          alternativeDocsError={alternativeDocsError}
        />
      </main>
    </div>
  );
