...
export default function ApplicationDetail() {
  ...
  const formattedDate = new Date(application.last_edited).toLocaleDateString(
    "en-US",
    {
      month: "long",
      day: "numeric",
      ...
      <main className="container mx-auto px-6 py-8 animate-fade-in">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div key={step.label} className="flex items-start gap-3">
                      <div className="flex flex-col items-center">
                        ...
                        {index < steps.length - 1 && (
                          <div
                            className={`w-0.5 h-8 ${step.completed ? "bg-emerald-400" : "bg-border"}`}
                          />
                        )}
                      </div>
                      <div className="pt-1">
                        <p
                          className={`font-medium ${step.current ? "text-foreground" : "text-slate-600"}`}
                        >
                          {step.label}
                        </p>
                      </div>
          ...
          <div className="space-y-6">
            ...
            {["Under Review", "Approved", "Requires Action"].includes(
