...
export default function ApplicationDetail() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="ccontainer mx-auto px-6 py-8 animate-fade-in">
        {/* Back Button */}
        <Button
          variant="ghost"
          onClick={() => navigate("/landingpage")}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {application.status === "Requires Action" &&
              application.actionRequired && (
                <Card className="border-status-requires-action/30 bg-status-requires-action/5">
                  <CardHeader className="pb-3">
                    <CardTitle className="flex items-center gap-2 text-status-requires-action text-lg">
                      ...
                      <div className="flex flex-col items-center">
                        <div
                          className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 ${
                            step.completed
                              ? "border-status-approved bg-status-approved"
                              : step.current
                        ...
                        {index < steps.length - 1 && (
                          <div
                            className={`w-0.5 h-8 ${
                              step.completed ? "bg-status-approved" : "bg-border"
                            }`}
                          />
                        )}
                      </div>
