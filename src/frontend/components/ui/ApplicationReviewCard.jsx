...
import { Clock, AlertTriangle, User, Building2, ArrowRight } from "lucide-react";
import { formatDistanceToNow, differenceInHours, parseISO } from "date-fns";
import { cn } from "../../lib/utils";

export function ApplicationCard({ application, onReview }) {
      ...
      <CardContent className="pb-3 space-y-3">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          >
            ...
            {isOverdue ? <span>SLA Breached</span> : <span>{hoursUntilSLA}h remaining</span>}
          </div>
        </div>
